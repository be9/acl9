...
also implemented it by hand (see Coming up with your own role implementation).
...
further). You can also use @:only@ and @:except@ options in the
...
<table>
  ...
  <tr>
    <td>None of the @allow@ and @deny@ rules matched.</td>
    <td>Access is allowed.</td>
    <td>Access is denied.</td>
  </tr>

  <tr>
    <td>Some of the @allow@ rules matched, none of the @deny@ rules matched.</td>
    <td>Access is allowed.</td>
    <td>Access is allowed.</td>
  </tr>
  <tr>
    <td>None of the @allow@ rules matched, some of the @deny@ rules matched.</td>
    <td>Access is denied.</td>
    <td>Access is denied.</td>
  </tr>
  <tr>
    <td>Some of the @allow@ rules matched, some of the @deny@ rules matched.</td>
    <td>Access is allowed.</td>
    <td>Access is denied.</td>
  </tr>
</table>
